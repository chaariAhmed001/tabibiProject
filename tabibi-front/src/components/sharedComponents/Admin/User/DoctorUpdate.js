  ...
  return (
    <div className="card shadow mb-4">
        <div className="card-header py-3">
            <h6 className="m-0 font-weight-semi-bold text-primary">Edit Doctor</h6>
        </div>
                ...
                <form  onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="row gx-3 ">
                        ...
                        <div className="input-group mb-3">
                            ...
                            <button className="btn btn-outline-secondary" type="button" id="button-addon2" onClick={addSkills}>+</button>
                        </div>
                    </div>
